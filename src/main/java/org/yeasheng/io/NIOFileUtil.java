...
public class NIOFileUtil {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String sPath = "D:"+ File.separator+"Java_dev_software"+File.separator+"flink-1.10.3-bin-scala_2.11.tgz";
        String tPath = "D:"+File.separator+"Java_dev_software"+File.separator+"IO.tar.gz";
        long start = System.currentTimeMillis();
        nioCpoy(sPath, tPath,1024);
        long end = System.currentTimeMillis();
        System.out.println("用时为：" + (end-start));
    }
